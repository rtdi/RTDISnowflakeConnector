...
public class SnowflakeLoaderBrowse extends BrowsingService<SnowflakeLoaderConnectionProperties> {
	
	private Connection conn;

	public SnowflakeLoaderBrowse(ConnectionController controller) throws IOException {
		super(controller);
	}

	@Override
	public void open() throws IOException {
		conn = SnowflakeLoaderFactory.getDatabaseConnection(getConnectionProperties());
	}
